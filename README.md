...
I'm an engineer and entrepreneur leveraging AI to solve meaningful problems in **healthcare**, **education**, and **crisis management**. With dual Master's degrees from **UC Berkeley** (Biomedical Engineering) and **CentraleSupélec** (Machine Learning), I bridge the gap between cutting-edge research and real-world impact.

Currently serving as **VP of Product & Engineering** at [Parallel Learning](https://parallellearning.com), where we're transforming how schools support students with learning differences.

## Ventures

| Company                                                     | Role                        | Focus                                                                       |
| ----------------------------------------------------------- | --------------------------- | --------------------------------------------------------------------------- |
| **[Parallel Learning](https://parallellearning.com)**       | VP of Product & Engineering | Teletherapy platform empowering K-12 students with learning differences     |
| **[Polygon](https://merylldindin.com/ventures/polygon/)**   | Co-Founder & CTO            | Remote diagnostics for ADHD, dyslexia & learning differences — raised $4.2M |
...
- **[Topological Data Analysis for Arrhythmia Detection](https://arxiv.org/abs/1906.05795)** — Novel deep learning approach using TDA for ECG classification (Springer, ICANN 2020)
- **[NIST Computer Vision Challenge](https://cdn.merylldindin.com/documents/nist-challenge.pdf)** — Phase 2 winner & "Best Assessment Data" award at [NIST PSCR 2020](https://www.nist.gov/ctl/pscr/open-innovation-prize-challenges/past-prize-challenges/2020-enhancing-computer-vision)
- **[Sleep Stage Classification with ML](https://medium.com/data-science/my-sweet-dreams-about-automatic-sleep-stage-classification-414128441728)** — EEG signal processing and automated sleep analysis
...
- **[US12346791B2](https://patents.google.com/patent/US12346791B2)** — Abnormality determination using persistent homology & autoencoders for ECG analysis
- **[EP4075330A1](https://patents.google.com/patent/EP4075330A1)** — Real-time manufacturing monitoring via CNN-based video analysis
- **[LU102785B1](https://patents.google.com/patent/LU102785B1)** — ML-driven simulation process for manufacturing systems

## Tech Stack

**Languages**

![TypeScript](https://img.shields.io/badge/TypeScript-1B1B1B?style=flat-square&logo=typescript&logoColor=white)
![Python](https://img.shields.io/badge/Python-1B1B1B?style=flat-square&logo=python&logoColor=white)
![SQL](https://img.shields.io/badge/SQL-1B1B1B?style=flat-square&logo=postgresql&logoColor=white)

**Frontend**

![Vue](https://img.shields.io/badge/Vue-1B1B1B?style=flat-square&logo=vuedotjs&logoColor=white)
![Nuxt](https://img.shields.io/badge/Nuxt-1B1B1B?style=flat-square&logo=data:image/svg+xml;base64,&logoColor=white)
![React](https://img.shields.io/badge/React-1B1B1B?style=flat-square&logo=react&logoColor=white)
![Vite](https://img.shields.io/badge/Vite-1B1B1B?style=flat-square&logo=vite&logoColor=white)
![Vuetify](https://img.shields.io/badge/Vuetify-1B1B1B?style=flat-square&logo=vuetify&logoColor=white)
![MUI](https://img.shields.io/badge/MUI-1B1B1B?style=flat-square&logo=mui&logoColor=white)

**Backend**

![NestJS](https://img.shields.io/badge/NestJS-1B1B1B?style=flat-square&logo=nestjs&logoColor=white)
![FastAPI](https://img.shields.io/badge/FastAPI-1B1B1B?style=flat-square&logo=fastapi&logoColor=white)
![GraphQL](https://img.shields.io/badge/GraphQL-1B1B1B?style=flat-square&logo=graphql&logoColor=white)
![Prisma](https://img.shields.io/badge/Prisma-1B1B1B?style=flat-square&logo=prisma&logoColor=white)

**AI & ML**

![Claude](https://img.shields.io/badge/Claude-1B1B1B?style=flat-square&logo=anthropic&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini-1B1B1B?style=flat-square&logo=googlegemini&logoColor=white)
![Hugging Face](https://img.shields.io/badge/Hugging_Face-1B1B1B?style=flat-square&logo=huggingface&logoColor=white)
![PyTorch](https://img.shields.io/badge/PyTorch-1B1B1B?style=flat-square&logo=pytorch&logoColor=white)
![TensorFlow](https://img.shields.io/badge/TensorFlow-1B1B1B?style=flat-square&logo=tensorflow&logoColor=white)
![Keras](https://img.shields.io/badge/Keras-1B1B1B?style=flat-square&logo=keras&logoColor=white)
![scikit-learn](https://img.shields.io/badge/scikit--learn-1B1B1B?style=flat-square&logo=scikitlearn&logoColor=white)

**Data**

![BigQuery](https://img.shields.io/badge/BigQuery-1B1B1B?style=flat-square&logo=googlebigquery&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-1B1B1B?style=flat-square&logo=postgresql&logoColor=white)
![MongoDB](https://img.shields.io/badge/MongoDB-1B1B1B?style=flat-square&logo=mongodb&logoColor=white)
![Redis](https://img.shields.io/badge/Redis-1B1B1B?style=flat-square&logo=redis&logoColor=white)
![dbt](https://img.shields.io/badge/dbt-1B1B1B?style=flat-square&logo=data:image/svg+xml;base64,&logoColor=white)
...
_Exploring the intersection of technology and human potential_
